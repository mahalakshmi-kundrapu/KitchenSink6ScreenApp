{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFICoreFoundation',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls CoreFoundation/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'CoreFoundation/simulator/NFICoreFoundationLoader.h',
                        'CoreFoundation/simulator/NFICoreFoundation.h',
                    ],
                    'xcode_settings': {
                        'ENABLE_BITCODE': 'NO',
