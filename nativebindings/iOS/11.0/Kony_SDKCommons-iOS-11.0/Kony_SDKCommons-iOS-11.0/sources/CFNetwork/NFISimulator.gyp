{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFICFNetwork',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls CFNetwork/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'CFNetwork/simulator/NFICFNetworkLoader.h',
                        'CFNetwork/simulator/NFICFNetwork.h',
                    ],
                    'xcode_settings': {
                        'ENABLE_BITCODE': 'NO',
                        'INFOPLIST_FILE': 'CFNetwork/Info.plist',
                        'OTHER_LDFLAGS': [
                            '-weak_framework CFNetwork',
                        ],
                    },
                },
        ],
