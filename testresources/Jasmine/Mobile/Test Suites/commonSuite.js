describe("checkTest", function() {
	...
	beforeEach(function() {
		var currForm = kony.automation.getCurrentForm();
      	if(currForm !== null && currForm !== "frmHome"){
          kony.automation.scrollToWidget([currForm,"navHome","Button0b4beb5a153b24d"]);
          kony.automation.button.click([currForm,"navHome","Button0b4beb5a153b24d"]);
        }
	});
	...
	it("SliderSelectedValue", async function() {
		...
		await kony.automation.playback.waitFor(["frmSlider","CopySlider0519b62d358a042"]);
		kony.automation.slider.slide(["frmSlider","CopySlider0519b62d358a042"], 91);
		expect(kony.automation.widget.getWidgetProperty(["frmSlider","CopySlider0519b62d358a042"], "selectedValue")).toBeGreaterThan(88);
		expect(kony.automation.widget.getWidgetProperty(["frmSlider","CopySlider0519b62d358a042"], "selectedValue")).toBeLessThan(93);
	});
